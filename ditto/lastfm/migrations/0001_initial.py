    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mbid', models.CharField(blank=True, db_index=True, help_text='MusicBrainz Identifier', max_length=36, unique=True, verbose_name='MBID')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('artist_mbid', models.CharField(blank=True, help_text='MusicBrainz Identifier', max_length=36, verbose_name='Artist MBID')),
                ('track_name', models.TextField(blank=True)),
                ('track_mbid', models.CharField(blank=True, help_text='MusicBrainz Identifier', max_length=36, verbose_name='Track MBID')),
                ('album_name', models.TextField(blank=True)),
                ('album_mbid', models.CharField(blank=True, help_text='MusicBrainz Identifier', max_length=36, verbose_name='Album MBID')),
