...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='bookmark',
            name='tags',
            field=taggit.managers.TaggableManager(verbose_name='Tags', through='pinboard.TaggedBookmark', to='pinboard.BookmarkTag', help_text='A comma-separated list of tags.'),
        ),
    ]
