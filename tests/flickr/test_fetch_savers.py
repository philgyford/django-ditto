...
class UserSaverTestCase(FlickrFetchTestCase):
    ...
    def test_saves_correct_user_data(self):
        ...
        self.assertEqual(user.fetch_time, datetime.now(tz=UTC))
        ...
        self.assertEqual(
            ...
            datetime.fromtimestamp(1093459273, tz=UTC),
        )
        self.assertEqual(
...
class PhotoSaverTestCase(FlickrFetchTestCase):
    ...
    def test_saves_correct_photo_data(self, save_tags):
        ...
        self.assertEqual(
            photo.permalink, "https://www.flickr.com/photos/philgyford/26069027966/"
        )
        self.assertFalse(photo.is_private)
        self.assertEqual(photo.summary, "Some test HTML. And another paragraph.")
        self.assertEqual(photo.fetch_time, datetime.now(tz=UTC))
        self.assertEqual(
            photo.post_time,
...
class PhotosetSaverTestCase(FlickrFetchTestCase):
    ...
    def test_saves_correct_photoset_data(self):
        ...
        self.assertEqual(photoset.fetch_time, datetime.now(tz=UTC))
        ...
        self.assertEqual(
            photoset.description, "<b>Some text here</b>\n\nAnd new lines!"
        )
