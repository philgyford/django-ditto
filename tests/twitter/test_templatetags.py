...
class AnnualTweetCountsTestCase(TestCase):
    def setUp(self):
        ...
        AccountFactory(user=self.user_3)
...
class AnnualFavoriteCountsTestCase(TestCase):
    def setUp(self):
        ...
        private_tweet = TweetFactory(post_time=datetime_from_str("2015-01-01 12:00:00"))
    ...
    def test_empty_years(self):
        ...
        tweet2018 = TweetFactory(post_time=datetime_from_str("2018-01-01 12:00:00"))
